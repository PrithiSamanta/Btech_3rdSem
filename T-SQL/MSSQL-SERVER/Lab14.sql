...
LEFT JOIN DEPARTMENT D
ON P.DEPARTMENTID=D.DEPARTMENTID
WHERE GETDATE() - JOININGDATE > 25

--11. Find department wise person counts. 
SELECT D.DEPARTMENTNAME DEPARTMENT,COUNT(PERSONID) PERSONS
FROM PERSON P
JOIN DEPARTMENT D
ON P.DEPARTMENTID=D.DEPARTMENTID
...
SELECT DEPARTMENTNAME DEPARTMENT,MAX(SALARY) MAX_SAL,MIN(SALARY) MIN_SALARY
FROM PERSON P
JOIN DEPARTMENT D
ON P.DEPARTMENTID=D.DEPARTMENTID
GROUP BY DEPARTMENTNAME
...
SELECT CITY CITY,SUM(SALARY) TOTAL_SAL,AVG(SALARY) AVG_SAL,MAX(SALARY) MAX_SAL,MIN(SALARY) MIN_SAL
FROM PERSON P
JOIN DEPARTMENT D
ON P.DEPARTMENTID=D.DEPARTMENTID
GROUP BY CITY
...
SELECT CITY,DEPARTMENTNAME,SUM(SALARY) TOTAL_SAL,AVG(SALARY) AVG_SAL,MAX(SALARY) MAX_SAL
FROM PERSON P
INNER JOIN DEPARTMENT D
ON P.DEPARTMENTID=D.DEPARTMENTID
...
SELECT DEPARTMENTNAME,SUM(SALARY) TOTAL_SAL 
FROM PERSON P
INNER JOIN DEPARTMENT D
ON P.DEPARTMENTID=D.DEPARTMENTID
GROUP BY DEPARTMENTNAME
