...
SELECT BRANCH AS BRANCH,AVG(SPI) AS AVG_SPI
FROM STUDENT_INFO S
JOIN RESULT R
ON S.RNO=R.RNO
GROUP BY BRANCH
...
SELECT BRANCH AS BRANCH,MAX(SPI) AS MAX_SPI,MIN(SPI) AS MIN_SPI
FROM STUDENT_INFO S
JOIN RESULT R
ON S.RNO=R.RNO
GROUP BY BRANCH
...
SELECT BRANCH AS BRANCH,COUNT(S.RNO) AS TOTAL_STUDENT
FROM STUDENT_INFO S
JOIN RESULT R
ON S.RNO=R.RNO
GROUP BY BRANCH
...
SELECT BRANCH AS BRANCH,SUM(SPI) AS TOTAL_SPI
FROM STUDENT_INFO S
JOIN RESULT R
ON S.RNO=R.RNO
GROUP BY BRANCH 
...
SELECT BRANCH BRANCH,COUNT(S.RNO) TOTAL_STUDENTS
FROM STUDENT_INFO S
JOIN RESULT R
ON S.RNO=R.RNO
WHERE SPI>8
...
SELECT BRANCH BRANCH,AVG(SPI) AVG_SPI
FROM STUDENT_INFO S
JOIN RESULT R
ON S.RNO=R.RNO
GROUP BY BRANCH
...
SELECT BRANCH BRANCH,COUNT(RNO) TOTAL_STUDENT
FROM STUDENT_INFO
GROUP BY BRANCH
HAVING COUNT(RNO)>1
...
SELECT BRANCH BRANCH,AVG(SPI) AVG_RESULT
FROM STUDENT_INFO S
JOIN RESULT R
ON S.RNO=R.RNO
GROUP BY BRANCH
...
SELECT BRANCH BRANCH,MAX(SPI) HIGHEST_SPI
FROM STUDENT_INFO S
JOIN RESULT R
ON S.RNO=R.RNO
GROUP BY BRANCH
...
SELECT BRANCH BRANCH,MAX(SPI)-MIN(SPI) DIFF
FROM STUDENT_INFO S
JOIN RESULT R
ON S.RNO=R.RNO
GROUP BY BRANCH
