...
SELECT UPPER('PRITHI'),LOWER('PRITHI')

--3. Display first three characters of your name. 
SELECT SUBSTRING('PRITHI',1,3)

--4. Display 3rd to 10th character of your name.
SELECT SUBSTRING('PRITHI',3,8)
...
SELECT SUBSTRING('SQL Server',1,4),SUBSTRING('SQL Server',6,10)
...
SELECT SUBSTRING(LASTNAME,LEN(LASTNAME)-1,2)
FROM EMPLOYEE
