...
-- (STDID INT,SNAME VARCHAR(50),CITY VARCHAR(50),SPI DECIMAL(4,2),BRANCH VARCHAR(50));
...
-- (EID INT,FIRSTNAME VARCHAR(50),LASTNAME VARCHAR(50),DEPARTMENT VARCHAR(50),SALARY DECIMAL(7,2),CITY VARCHAR(50),GENDER VARCHAR(10),JOININGYEAAR INT)
